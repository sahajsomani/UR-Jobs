...
$sql = "SELECT job_id, emp_id, email, wage, post_date, title, location, description, IF(flexible, 'yes', 'no') flexible, name from EMPLOYERS NATURAL JOIN JOBS where job_id IN (SELECT job_id from FAVORITES where net_id='$currUser');";
	...
	<?php while($row = $result->fetch_assoc()) { ?>
		<div class="card">
			...
			<div class="card-body">	
				...
				?>
						<span style="padding-right: 10px;"> <i>You have already applied to this job</i> </span>
						<input type="submit" name="fav" value="Unfavorite" style="border: none; color: #007bff;">
				<?php
					}
				?>
